...
def app():
    ...
    with col1:
        ...
        if not st.session_state.signedout:
            ...
            with col3:
                choice = st.button('Login', key='login_button', on_click='Login')  
            with col4:
                choice = st.button('signup', key='signup_button', on_click='Sign Up')
    ...
    with col2:
        ...
        col3 = st.columns(1)
        with col3:
            st.subheader('General Telecommunication Customer Churn Overview')
